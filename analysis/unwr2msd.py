...
myDir='/home/hf210/molsim/lammps_run/teth_pim1/helium/'
filename='unwrap_he-T293.dump'




nts_run = 20000000 # nr of production run time steps
...
it0max=50 # maximum nr of time origins t0 
...
for i in xrange(N):
    ...
    r[int(line[0])-1-n1]=np.array(line[7:10],dtype='float64') 
